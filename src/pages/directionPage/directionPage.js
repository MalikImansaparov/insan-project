...
import {newsUrl, base, uri} from "../../api/const";
...
export const DirectionPage = () => {
    const { isLoading } = useFetch(base + newsUrl + '/news/src/insan/');
    ...
    return (
      <div className="wrapper font-inter">
        ...
        <div className="flex justify-center flex-wrap wrapper pb-8">
          {response.results &&
